...
if [ ! -f /var/www/html/wp-config.php  ]; then
    ...
    && wp core install --url=cloud1-is-clacked-on-the-floor.duckdns.org --title=$WP_TITLE --admin_user=$WP_ADMIN --admin_password=$WP_ADMIN_PASS --admin_email=$WP_ADMIN_MAIL --skip-email --allow-root \
